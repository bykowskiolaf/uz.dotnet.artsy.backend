...
public class ArtsyArtistDto
{
	...
	public List<string>? ImageVersions { get; set; }

	[JsonPropertyName("_links")]
	public ArtsyArtistLinksDto? Links { get; set; }
}

public class ArtsyArtistLinksDto
{
	[JsonPropertyName("thumbnail")]
	public ArtsyLinkDto? Thumbnail { get; set; }

	[JsonPropertyName("image")]
	public ArtsyImageLinkDto? Image { get; set; }

	[JsonPropertyName("artworks")]
	public ArtsyLinkDto? Artworks { get; set; }
}
